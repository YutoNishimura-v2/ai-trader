...
| **`iter11/pivot_bounce_v2`** | **iter11: pivot_bounce with tighter touch_atr_buf=0.05 + sl_atr_buf=0.20 (validation-disciplined parameter sweep winner)** | **Full +27.21% (¥+27,210), Research +39.97% (PF 2.32), Validation +4.23% (PF 2.18), Tournament 14d -9.38% / 7d -10.10%** | **iter11 standalone winner — STRONGEST non-news standalone in project history; full Jan-Apr ¥100,000 → ¥127,210; April tournament hostile to pivot reversals** |
