...
| **`iter19/ensemble_pivot_triple`** | **iter19: pivot DAILY + WEEKLY + MONTHLY (added 'monthly' to pivot_period)** | **Full +69.17% (¥+69,167; ¥100k → ¥169,167), Research +60.05% (PF 1.84), Validation +15.20% (PF 2.50), Tournament 14d -15.96%, DD -21.1%** | **iter19 PROJECT RECORD — monthly pivots improve April from -6.29% to -4.32% AND val from +11.79% to +15.20%; strongest non-news ensemble in project history** |
