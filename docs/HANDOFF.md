...
| **`iter24/triple_aggressive_v4`** | **iter24: v3 + weekly tp2_rr 2.0→2.5** | **Full +166.23% (¥+166,231; ¥100k → ¥266,231), Research +68.86% (PF 1.44), Validation +17.76% (PF 1.78), Tournament 14d -22.15%, DD -32.7%** | **iter24 PROJECT RECORD — 2.66x in 4 months; Jan +49.81 (¥+49,808), Feb +71.72 (¥+107,445), Mar +9.69, Apr -5.66, 0 cap viol** |
