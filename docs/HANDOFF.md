...
| **`iter14/pivot_bounce_london_v4`** | **iter14: v3 + risk pushed to 5.0% (validation-disciplined risk sweep)** | **Full +53.90% (¥+53,899; ¥100k → ¥153,899), Research +55.92% (PF 1.90), Validation +9.49% (PF 2.79), Tournament 14d -18.18% / 7d -15.13%, DD -20.6%, min_eq 95.3%** | **iter14 standalone WINNER — strongest non-news full-period in project history; March alone +37.12% (¥+47,135); April tournament hostile remains** |
