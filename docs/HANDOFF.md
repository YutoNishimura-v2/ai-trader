...
| **`iter15/pivot_bounce_london_v7`** | **iter15: v4 + light DD throttle (soft=12, mult=0.7)** | **Full +57.95% (¥+57,946; ¥100k → ¥157,946), Research +55.92% (PF 1.90), Validation +9.49% (PF 2.79), Tournament 14d -16.27% / 7d -15.68%, DD -18.5%** | **iter15 standalone WINNER — strongest non-news full-period in project history; March alone +37.12% (¥+47,135); throttle softens Apr from -11.61% to -9.29%** |
