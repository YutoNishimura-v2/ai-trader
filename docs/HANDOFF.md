...
| **`iter17/pivot_bounce_london_v8`** | **iter17: v7 + cooldown 30→60 + daily_kill 5→3** | **Full +60.56% (¥+60,560; ¥100k → ¥160,560), Research +67.32% (PF 2.14), Validation +9.49% (PF 2.79), Tournament 14d -14.11% / 7d -11.12%, DD -15.5%** | **iter17 standalone WINNER — strongest non-news full+research in project history; tighter daily kill softens Apr from -9.29% to -5.85% AND tournament 14d from -16.27% to -14.11%** |
