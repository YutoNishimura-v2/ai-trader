...
| **`iter25/triple_single_tp`** | **iter25: v4 with SINGLE TP=1.0R per user feedback ("TP1 alone would be enough")** | **Full +102.26% (¥+102,261; ¥100k → ¥202,261), Validation +18.47% (PF 1.90), Tournament 14d -16.73% / 7d -8.30%, DD -33.5%** | **iter25 SIMPLER + STRONGER VALIDATION — same triple-pivot edges with single TP at 1.0R; better tournament (-16.73 vs -22.15) and val PF (1.90 vs 1.78); easier live execution** |
