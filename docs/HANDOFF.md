...
| **`iter20/ensemble_pivot_triple_v2`** | **iter20: triple ensemble at risk=7.0% (lifted from 5.0)** | **Full +102.43% (¥+102,430; ¥100k → ¥202,430), Research +69.70% (PF 1.65), Validation +17.65% (PF 2.15), Tournament 14d -18.35%, DD -26.2%** | **iter20 PROJECT RECORD — DOUBLED starting balance over 4 months on real held-out data; Jan +15.21, Feb +52.72, Mar +23.01, Apr -6.47, 0 cap viol** |
