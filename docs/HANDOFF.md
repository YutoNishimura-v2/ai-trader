...
| **`iter13/pivot_bounce_london_v3`** | **iter13: London-only pivot_bounce, TP1=1.0R, TP2=1.5R (validation-disciplined session+TP sweep winner)** | **Full +30.10% (¥+30,098), Research +32.79% (PF 2.51), Validation +5.61% (PF 4.69), Tournament 14d -8.75% / 7d -7.87%, DD -10.7% min_eq 97.6%** | **iter13 standalone winner — strongest VALIDATION PF (4.69) + strongest min_eq (97.6%) in project history; April tournament still hostile** |
