...
| **`iter18/ensemble_pivot_dual`** | **iter18: pivot_bounce DAILY + WEEKLY (NEW pivot_period param)** | **Full +64.68% (¥+64,675; ¥100k → ¥164,675), Research +57.44% (PF 1.85), Validation +11.79% (PF 2.11), Tournament 14d -15.96% / 7d ?, DD -19.2%** | **iter18 ensemble WINNER — weekly pivot levels FIX January (was -4% in v8; now +9.13%); strongest non-news full-period in project history** |
