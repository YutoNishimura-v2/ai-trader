...
| **`iter22/triple_aggressive_v2`** | **iter22: triple at risk=10 + daily sl_atr_buf 0.20→0.30** | **Full +114.38% (¥+114,384; ¥100k → ¥214,384), Research +69.80% (PF 1.45), Validation +16.89% (PF 1.78), Tournament 14d -19.46%, DD -33.2%** | **iter22 PROJECT RECORD — wider daily SL improves both full AND val; Jan +22.30, Feb +68.61, Mar +12.69, Apr -7.74, 0 cap viol** |
