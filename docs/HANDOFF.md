...
| **`iter23/triple_aggressive_v3`** | **iter23: v2 + weekly sl_atr_buf 0.25→0.28** | **Full +146.61% (¥+146,614; ¥100k → ¥246,614), Research +68.86% (PF 1.44), Validation +16.85% (PF 1.76), Tournament 14d -22.15%, DD -31.8%** | **iter23 PROJECT RECORD — 2.46x starting balance over 4 months; Jan +37.49, Feb +70.03, Mar +10.84, Apr -4.83, 0 cap viol** |
