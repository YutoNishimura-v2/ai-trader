...
- **`iter235`** — lowest **worst_score** (~0.04), 3/4.
- **`iter244`** — **4/4** + best Mar/Apr combo with tail ~0.34 (not ~1.4 like 236).

## Next probes

1. Held-out validation for **iter235** / **iter244**.
2. **iter227** April sleeve alongside handoff core (two-config, not one YAML).
